...
class GameFlow extends IGame {
    ...
    run() {
        return new Promise((resolve, reject) => {
            ...
            this.GameConfiguration.globalTimer = new GlobalTimer(this.GameConfiguration.channelsHandler._channels.get(
                this.GameConfiguration.channelsHandler.channels.cristal_lake_lg
            ));
            ...
            this.GameConfiguration.channelsHandler._channels.get(this.GameConfiguration.channelsHandler.channels.cristal_lake_lg)
                .send(new MessageEmbed().setColor(BotData.BotValues.botColor)
                    .setAuthor("Les Loups-garous de Cristal Lake", lg_var.roles_img.LoupGarou)
                    .setDescription('Développé par julioju.\n\n*Cristal Lake est un petit village rural d\'apparence paisible,' +
                    ...
                    .setFooter("Bienvenue à Cristal Lake, sa campagne paisible, son école charmante, sa population accueillante, ainsi que " +
                        "ses traditions ancestrales et ses mystères inquiétants.", lg_var.roles_img.LoupGarou)
                    .setImage(lg_var.roles_img.LoupGarou))
                .then(() => this.GameConfiguration.channelsHandler._channels.get(this.GameConfiguration.channelsHandler.channels.cristal_lake_lg)
                    .send(new MessageEmbed().setColor(BotData.BotValues.botColor)
                        .addField(
                            "Table ronde",
    ...
    async gameLoop() {
        ...
        while (await this.gameEnded() === false) {
            ...
            await this.GameConfiguration.channelsHandler.sendMessageToVillage("La nuit va bientôt tomber sur Cristal Lake...");
...
class Day extends Period {
    ...
    async debateTime() {
        ...
        await this.GameConfiguration.channelsHandler.sendMessageToVillage(
            `Le jour se lève sur Cristal Lake 🌄`
        );
        ...
        await this.GameConfiguration.channelsHandler.sendMessageToVillage(
            `Votez dans le channel ${this.GameConfiguration.channelsHandler._channels.get(this.GameConfiguration.channelsHandler.channels.cristal_lake_lg).toString()} !`
        );
    ...
    goThrough() {
        return new Promise((resolve, reject) => {
            ...
            this.GameConfiguration.channelsHandler.sendMessageToVillage(
                "🌄 Le jour se lève à Cristal Lake." +
                ...
                .then(() => this.GameConfiguration.channelsHandler.sendMessageToVillage("⛰ La nuit va bientôt tomber sur Cristal Lake."))
                .then(() => this.GameConfiguration.globalTimer.setTimer(
                    0.5,
                    "Temps avant la tombée de la nuit",
                    this.GameConfiguration.getAlivePlayers().length
        ...
        return new Promise((resolve, reject) => {
            ...
            this.GameConfiguration.channelsHandler.sendMessageToVillage(
                ...
                if (outcome.length === 0) {
                    ...
                    this.GameConfiguration.channelsHandler.sendMessageToVillage(
                        `${capitaineElected.member.displayName} a été élu Capitaine de Cristal Lake !`
                    ).catch(console.error);
