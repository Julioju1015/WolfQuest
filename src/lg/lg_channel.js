...
class ChannelsHandler extends IGame {
    ...
    checkCategory() {
        return new Promise((resolve, reject) => {
            ...
            let channel = this.guild.channels.cache.find(x => x.name === "loups_garou_cristal_lake");
    ...
    async createChannels() {
        ...
        if (!this.category) {
            let categoriesCreated = await this.guild.channels.create("loups_garou_cristal_lake", {type: 'category'});
    ...
    sendMessageToVillage(message, imageLink, thumbnail) {
        ...
        let msg = new MessageEmbed()
            ...
            .setAuthor("Loup-Garou de Cristal Lake", lg_var.roles_img.LoupGarou);
    ...
    deleteMessagesInChannels() {
        return new Promise((resolve, reject) => {
            ...
            promises.push(this.deleteMessagesInChannel(this._channels.get(this.channels.cristal_lake_lg)));
